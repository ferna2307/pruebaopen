...
PLATFORM_NAME = _('AulaNet')
PLATFORM_DESCRIPTION = _('TRANSFORMANDO AL MUNDO EDUCATIVO')
...
TIME_ZONE = 'America/La_Paz'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
